                            ...
                            <div class="flex h-screen overflow-hidden bg-bg-primary">
                                ...
                                <aside class="hidden md:flex flex-col w-64 border-r border-gray-800 bg-[#121826]">
                                    <a href="${pageContext.request.contextPath}/home"
                                        ...
                                        <div
                                            class="w-10 h-10 bg-btn-primary rounded-xl flex items-center justify-center text-black font-bold text-xl">
                                            A</div>
                                                ...
                                                <div class="space-y-1.5">
                                                    <div class="flex justify-between items-center">
                                                        <label class="text-gray-300 text-sm font-medium">Mật khẩu mới
                                                            *</label>
                                                        <span class="text-xs text-gray-500">Từ 8 ký tự, hoa, thường, số,
                                                            ký tự đặc biệt</span>
                                                    </div>
                                                    <div class="relative">
                                                        <div
