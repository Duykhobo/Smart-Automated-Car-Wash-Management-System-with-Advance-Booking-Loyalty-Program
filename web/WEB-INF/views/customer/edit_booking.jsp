                                ...
                                <c:when test="${not empty services}">
                                    <c:forEach var="service" items="${services}">
                                        <label class="block relative cursor-pointer group">
                                            ...
                                            <input type="checkbox" name="services" value="${service.serviceId}" data-base-price="${service.basePrice}" data-duration="${service.durationMinutes}" class="peer sr-only" ${isServiceChecked ? 'checked' : ''}>
