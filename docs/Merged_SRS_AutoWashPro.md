...
*   *Các trường:*
    ...
    *   `FirstName` (NVARCHAR(50), Not Null): Tên gọi chính của khách hàng.
    *   `LastName` (NVARCHAR(50), Not Null): Họ và tên đệm.
...
*   `POST /api/auth/register`
    *   *Dữ liệu gửi lên (Payload):* `{"firstName":"...", "lastName":"...", "phone":"...", "licensePlate":"...", "password":"..."}`
